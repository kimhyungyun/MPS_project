  ...
  <section className="w-full min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
    ...
    <div className="max-w-7xl mx-auto px-4 lg:px-24 py-8">
      <div className="space-y-12">
        ...
        {/* 문대원 */}
        <div className="bg-[#f2f2f2] rounded-2xl shadow-md p-8 transform hover:scale-[1.02] transition-transform duration-300">
          <div className="flex flex-col lg:flex-row gap-8 items-center justify-center">
            ...
            <div className="lg:w-2/3 text-center lg:text-left">
              ...
              <div className="space-y-3">
                <p className="text-gray-700">• (전) 남경한의원 원장</p>
                <p className="text-gray-700">• (전) 동신대학교 외래교수</p>
                <p className="text-gray-700">• (현) 효사랑 가족요양병원 한방과 과장</p>
                <p className="text-gray-700">• (현) MPS연구회 회장</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#f2f2f2] rounded-2xl shadow-md p-8 transform hover:scale-[1.02] transition-transform duration-300">
          <div className="flex flex-col lg:flex-row gap-8 items-center justify-center">
            ...
            <div className="lg:w-2/3 text-center lg:text-left">
              ...
              <div className="space-y-3">
                <p className="text-gray-700">• (현) 동신대학교 정교수</p>
                <p className="text-gray-700">• (현) MPS 연구회 전임강사</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#f2f2f2] rounded-2xl shadow-md p-8 transform hover:scale-[1.02] transition-transform duration-300">
          <div className="flex flex-col lg:flex-row gap-8 items-center justify-center">
            ...
            <div className="lg:w-2/3 text-center lg:text-left">
              ...
              <div className="space-y-3">
                <p className="text-gray-700">• (전) 전라남도 화순군 공중보건의사</p>
                <p className="text-gray-700">• (현) MPS 연구회 보조강사</p>
                <p className="text-gray-700">• (현) 터한의원 분당점 부원장</p>
              </div>
            </div>
          </div>
        </div>

...
13. 개인정보관리 책임자 및 담당자
"경근근막엠피에스(MPS연구회)"는 이용자가 좋은 정보를 안전하게 이용할 수 있도록 최선을 다하고 있습니다. 개인정보를 보호하는데 있어 이용자에게 고지한 사항들에 반하는 사고가 발생할 경우 개인정보관리책임자가 책임을 집니다. 그러나 기술적 · 관리적 보완조치를 했음에도 불구하고, 해킹 등 기본적인 네트워크상의 위험성에 의해 발생하는 예기치 못한 사고로 인한 정보의 훼손 및 방문자가 작성한 게시물에 의한 각종 분쟁에 관해서는 "경근근막엠피에스(MPS연구회)"의 책임이 없습니다. 또한 이용자 개인정보와 관련한 아이디(ID)의 비밀번호에 대한 보안유지책임은 해당 이용자 자신에게 있습니다. "경근근막엠피에스(MPS연구회)"는 비밀번호에 대해 어떠한 방법으로도 이용자에게 직접적으로 질문하는 경우는 없으므로 타인에게 비밀번호가 유출되지 않도록 각별히 주의하시기 바랍니다. 특히 공공장소의 온라인상에서 접속해 있을 경우에는 더욱 유의하셔야 합니다. "경근근막엠피에스(MPS연구회)"는 개인정보에 대한 의견수렴 및 불만처리를 담당하는 개인정보 관리책임자 및 담당자를 지정하고 있고, 연락처는 아래와 같습니다.
소속 / 직위　: 개인정보관리책임자
E-M A I L 　 : pimang_235@naver,com
전 화 번 호　: 010-7942-5854

15. 아동의 개인정보보호
"경근근막엠피에스(MPS연구회)"는 온라인 환경에서 만 14세 미만 어린이의 개인정보를 보호하는 것 역시 중요한 일이라고 생각하고 있습니다. "경근근막엠피에스(MPS연구회)"는 만 14세 미만의 어린이들은 법정대리인의 동의가 없는 한 회원으로 가입할 수 없게 하고 있습니다. 즉, 만 14세 미만의 어린이들은 법정대리인의 동의가 있을 때만 "경근근막엠피에스(MPS연구회)"에서 회원 자격의 서비스를 받을 수 있습니다.
